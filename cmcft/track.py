...
# Test1
images = parent + '/datasets/Fluo-N2DH-SIM/01_GT/SEG'
# Test2
#images = parent + '/datasets/PhC-C2DH-U373/01_GT/SEG'

# Setup save area
save = parent + '/datasets/test_results'
previous_saves = glob.glob(save + '/*')
for f in previous_saves:
    os.remove(f)

# Calling script
track_cmcf(images, save, annotated=True, csv=True)
